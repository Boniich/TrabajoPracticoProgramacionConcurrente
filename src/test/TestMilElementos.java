...
//su version concurrente/paralela (1000 Elementos)
...
//3- Unicamente en este primer test se muestra los array pre y post ordenamientos
...
public class TestMilElementos {
	...
	public static void main(String[] args) {
		...
		//Se muestra el array para el ordenamiento secuencial
		//antes de ser ordenado
        System.out.println("--- Sec (Pre ordenamiento) ---");
        for (int val : arraySecuencial) {
        ...
        //Se mide el tiempo y ordena el array usando el algoritmo secuencial
		 ...
		 //Se muestra el array para el algoritmo secuencial 
		 //post ordenamiento
        System.out.println("\n--- Sec (Post ordenamiento) ---");
        for (int val : arraySecuencial) {
           System.out.print(val + " ");  
        }
        ...
        //Se muestra el array para el algoritmo paralelo pre ordenamiento
        System.out.println("\n--- Con (Pre ordenamiento) ---");
        for (int val : arrayParalelo) {
           System.out.print(val + " ");  
        }
        ...
        //Se muesta el array para el algoritmo concurrente 
        //post ordenamiento
        System.out.println("\n--- Con (Post ordenamiento) ---");
	  for (int val : arrayParalelo) {
	  	  System.out.print(val + " "); 
	  }
